...
Thank you for your interest in `loopback-example-model-relations`, an open source project
administered by StrongLoop.

Contributing to `loopback-example-model-relations` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/strongloop/loopback-example-model-relations)
